...
describe('Startup', () => {
  ...
  test('should have the right title', () => {
    expect(app.client.getTitle()).resolves.toEqual('BZWallet');
  });

  test('should show the text "BZWallet Starting" in loading screen', async () => expect(app.client.element('#loading-screen:first-child p').getHTML()).resolves.toEqual(
